...
MC_LABEL="friedutchplus.minecraft"
...
cp /Users/administrator/Sites/friedutchplus/projects/minecraft/ops/friedutchplus.minecraft.plist.example "$MC_PLIST_TARGET"
